...
QBShared.Weapons = {
	...
	---custom ---
	[`weapon_huntsniper`]					= {['name'] = 'weapon_huntsniper',				['label'] = 'hunting sniper',						['ammotype'] ='AMMO_SNIPER',						['damagereason'] = 'hunted'},
	[`weapon_katanas`]					= {['name'] = 'weapon_katanas',				['label'] = 'golden katana',						['ammotype'] = nil,						['damagereason'] = 'sliced'},
	[`weapon_khaled`]					= {['name'] = 'weapon_khaled',				['label'] = 'zeb',						['ammotype'] = nil,						['damagereason'] = 'nakoh'},
	 --GD-WEAPONS
